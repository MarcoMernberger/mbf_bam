...
module_dir = os.path.join(__location__, "../src/mbf_bam")
try:
...
try:
    from mbf_bam import __version__ as version
except ImportError:
    pass
else:
    release = version
...
latex_documents = [
  ('index', 'user_guide.tex', u'mbf_bam Documentation',
...
def setup(app):
    ...
    github_doc_root = "https://github.com/TyberiusPrime/mbf_bam"
